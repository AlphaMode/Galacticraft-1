...
public class GCItemNames
{
    ...
    public static final String oxTankHeavy = "oxygen_tank_heavy_full";
    public static final String oxTankLight = "oxygen_tank_light_full";
    public static final String oxTankMedium = "oxygen_tank_med_full";
    ...
    public static final String parachuteLightBlue = "parachute_light_blue";
    ...
    public static final String parachuteGreen = "parachute_green";
    public static final String parachuteLightGray = "parachute_light_gray";
    ...
    public static final String parachuteWhite = "parachute_white";
    public static final String parachutePurple = "parachute_purple";
    public static final String parachuteRed = "parachute_red";
    public static final String parachuteTeal = "parachute_cyan";
