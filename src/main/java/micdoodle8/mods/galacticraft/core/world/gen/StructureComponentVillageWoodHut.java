...
public class StructureComponentVillageWoodHut extends StructureComponentVillage
{
    ...
    public StructureComponentVillageWoodHut(TemplateManager manager, CompoundNBT nbt)
    {
        super(GCFeatures.CMOON_VILLAGE_WOOD_HUT, nbt);
        this.averageGroundLevel = nbt.getInt("AvgGroundLevel");
    }

    public StructureComponentVillageWoodHut(StructureComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, MutableBoundingBox par4StructureBoundingBox, Direction par5)
    {
        super(GCFeatures.CMOON_VILLAGE_WOOD_HUT, par1ComponentVillageStartPiece, par2);
    ...
    public static StructureComponentVillageWoodHut func_74908_a(StructureComponentVillageStartPiece par0ComponentVillageStartPiece, List<StructurePiece> par1List, Random par2Random, int par3, int par4, int par5, Direction par6, int par7)
    {
        ...
        return StructurePiece.findIntersecting(par1List, var8) == null ? new StructureComponentVillageWoodHut(par0ComponentVillageStartPiece, par7, par2Random, var8, par6) : null;
    }
    ...
    public boolean create(IWorld par1World, ChunkGenerator<?> chunkGenerator, Random par2Random, MutableBoundingBox par3StructureBoundingBox, ChunkPos chunkPos)
    {
        ...
        this.setBlockState(par1World, GCBlocks.glowstoneTorchWall.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, this.getCoordBaseMode().rotateYCCW()), 14, yLevel, 8, par3StructureBoundingBox);
        ...
        this.setBlockState(par1World, GCBlocks.glowstoneTorchWall.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, this.getCoordBaseMode().rotateY()), 2, yLevel, 8, par3StructureBoundingBox);
