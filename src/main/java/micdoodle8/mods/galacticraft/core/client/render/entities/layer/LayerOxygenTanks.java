        ...
        if (!player.isInvisible())
        {
            ...
            if (gearData != null)
            {
                ...
                for (int i = 0; i < 2; ++i)
                {
                    ...
                    {
                        this.redOxygenTanks[0].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }

                    if (wearingLeftTankOrange)
                    {
                        this.orangeOxygenTanks[0].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }

                    if (wearingLeftTankGreen)
                    {
                        this.greenOxygenTanks[0].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }
                    ...
                    {
                        this.redOxygenTanks[1].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }

                    if (wearingRightTankOrange)
                    {
                        this.orangeOxygenTanks[1].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }

                    if (wearingRightTankGreen)
                    {
                        this.greenOxygenTanks[1].render(matrixStackIn, bufferIn.getBuffer(RenderType.getSolid()), packedLightIn, OverlayTexture.NO_OVERLAY);
                    }
