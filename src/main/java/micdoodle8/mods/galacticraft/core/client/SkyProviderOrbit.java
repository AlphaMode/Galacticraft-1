...
public class SkyProviderOrbit implements SkyRenderHandler
{
    ...
    public int starGLCallList = GL15.glGenLists(3);
...
//            }
        ...
        if (this.renderSun)
        {
            ...
            worldRenderer.pos(-var12, 100.0D, -var12).tex(0.0f, 0.0f).endVertex();
            worldRenderer.pos(var12, 100.0D, -var12).tex(1.0f, 0.0f).endVertex();
            worldRenderer.pos(var12, 100.0D, var12).tex(1.0f, 1.0f).endVertex();
            worldRenderer.pos(-var12, 100.0D, var12).tex(0.0f, 1.0f).endVertex();
            var23.draw();
        }
        ...
        if (this.planetToRender != null)
        {
            ...
            BufferBuilder worldRenderer = var23.getBuffer();
            worldRenderer.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
            worldRenderer.pos(-var10, 0, var10).tex(0f, 1.0f).endVertex();
            worldRenderer.pos(var10, 0, var10).tex(1.0f, 1.0f).endVertex();
            worldRenderer.pos(var10, 0, -var10).tex(1.0f, 0f).endVertex();
            worldRenderer.pos(-var10, 0, -var10).tex(0f, 0f).endVertex();
            var23.draw();
            GL11.glPopMatrix();
        }
