...
//            mc.entityRenderer.setupOverlayRendering();
            ...
            EntityRenderer<EntitySpaceshipBase> spaceshipRender = (EntityRenderer<EntitySpaceshipBase>) mc.getRenderManager().renderers.get(rocket.getType());
...
//            int j = i % 65536;
//            int k = i / 65536;
//            RenderSystem.glMultiTexCoord2f(GL15.GL_TEXTURE1, (float) j, (float) k);
            RenderSystem.color4f(1.0F, 1.0F, 1.0F, 1.0F);
            ...
            try
            {
                IRenderTypeBuffer.Impl source = mc.getRenderTypeBuffers().getBufferSource();
                MatrixStack stack = new MatrixStack();
                spaceshipRender.render((EntitySpaceshipBase) mc.player.getRidingEntity(), 0, 0, stack, source, 15728880);
