...
{
    public static final EnumProperty<GlassModel> MODEL = EnumProperty.create("modeltype", GlassModel.class);
...
//    @Override
//    public List<ItemStack> getDrops(BlockState state, int fortune)
//    {
...
//    @Override
//    public void addCollisionBoxToList(BlockState state, World worldIn, BlockPos pos, AxisAlignedBB mask, List<VoxelShape> list, @Nullable Entity entityIn, boolean p_185477_7_)
//    {
...
//    @Override
//    @OnlyIn(Dist.CLIENT)
//    public VoxelShape getSelectedBoundingBox(BlockState bs, World worldIn, BlockPos pos)
//    {
//        return this.getBoundingBox(bs, worldIn, pos).offset(pos);
//    }

    @Override
    public VoxelShape getShape(BlockState bs, IBlockReader worldIn, BlockPos pos, ISelectionContext context)
    {
...
//    }
    ...
    @Override
    public int setColor(int newColor, PlayerEntity p)
    {
    ...
    {
        int changes = 0;
        changes += GCBlocks.spaceGlassVanilla.setColor(color1, null);
        changes += GCBlocks.spaceGlassClear.setColor(color2, null);
        changes += GCBlocks.spaceGlassStrong.setColor(color3, null);
...
//        Minecraft.getInstance().renderGlobal.loadRenderers();
    ...
    public enum GlassRotation implements IStringSerializable
    {
        ...
        private GlassRotation(String name, int x, int y, int z)
        {
            this.name = name;
            this.x = x;
            this.y = y;
    ...
    public enum GlassFrame implements IStringSerializable, IExtensibleEnum
    {
        ...
        public static GlassFrame create(String enumName, String name, int color)
        {
            throw new IllegalStateException("Enum not extended");
        }
    }

    public enum GlassType implements IStringSerializable, IExtensibleEnum
    {
        VANILLA("vanilla"),
        CLEAR("clear"),
        STRONG("strong");
        ...
        public static GlassType create(String enumName, String name)
        {
            throw new IllegalStateException("Enum not extended");
        }
    }
