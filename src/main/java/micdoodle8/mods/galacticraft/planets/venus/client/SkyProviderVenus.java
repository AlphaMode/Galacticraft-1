...
@OnlyIn(Dist.CLIENT)
public class SkyProviderVenus implements SkyRenderHandler
{
...
//        }
        ...
        worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
        worldRenderer1.pos(last3, -f10, -100.0F, f10).tex(0, 1.0F).endVertex();
        worldRenderer1.pos(last3, f10, -100.0F, f10).tex(1.0F, 1.0F).endVertex();
        worldRenderer1.pos(last3, f10, -100.0F, -f10).tex(1.0F, 0).endVertex();
        worldRenderer1.pos(last3, -f10, -100.0F, -f10).tex(0, 0).endVertex();
        tessellator1.draw();
        ...
        if (d0 < 0.0D)
        {
            ...
            f9 = -((float) (d0 + 65.0D));
            f10 = -f8;
            Matrix4f last4 = matrixStack.getLast().getMatrix();
            worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_COLOR);
            worldRenderer1.pos(last4, -f8, f9, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, f8, f9, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, f8, f10, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, -f8, f10, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, -f8, f10, -f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, f8, f10, -f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last4, f8, f9, -f8).color(0, 0, 0, 1.0F).endVertex();
