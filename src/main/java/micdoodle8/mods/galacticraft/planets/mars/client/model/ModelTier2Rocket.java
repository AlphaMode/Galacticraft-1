...
public class ModelTier2Rocket extends EntityModel<EntityTier2Rocket>
{
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        for (var1 = 0; var1 < this.fins.length; var1++)
        {
            ...
            {
                this.fins[var1][var2].render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
            }
        }
        ...
        for (var1 = 0; var1 < this.boosters.length; var1++)
        {
            ...
            {
                this.boosters[var1][var2].render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
            }
        }
    }
    ...
    @Override
    public void setRotationAngles(EntityTier2Rocket entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch)
    {
    }
}
