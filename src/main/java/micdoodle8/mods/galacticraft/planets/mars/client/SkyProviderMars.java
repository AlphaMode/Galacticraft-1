 ...
 */
@OnlyIn(Dist.CLIENT)
public class SkyProviderMars implements SkyRenderHandler
{
...
//        }
        ...
        if (f18 > 0.0F)
        {
            ...
            matrixStack.rotate(Vector3f.YP.rotationDegrees(-19.0F));
...
//        }
        ...
        worldRenderer1.pos(last, 0.0F, 100.0F, 0.0F).color(r, g, b, a).endVertex();
        byte b0 = 16;
        r = afloat[0] * f18;
        g = afloat[1] * f18;
        b = afloat[2] * f18;
        ...
        // Render sun aura
        f10 = 20.0F;
        worldRenderer1.pos(last, -f10, 100.0F, -f10).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, 0, 100.0F, -f10 * 1.5F).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, f10, 100.0F, -f10).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, f10 * 1.5F, 100.0F, 0).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, f10, 100.0F, f10).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, 0, 100.0F, f10 * 1.5F).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, -f10, 100.0F, f10).color(r, g, b, a).endVertex();
        worldRenderer1.pos(last, -f10 * 1.5F, 100.0F, 0).color(r, g, b, a).endVertex();
        ...
        worldRenderer1.pos(last2, -f10, 99.9F, -f10).endVertex();
        worldRenderer1.pos(last2, f10, 99.9F, -f10).endVertex();
        worldRenderer1.pos(last2, f10, 99.9F, f10).endVertex();
        worldRenderer1.pos(last2, -f10, 99.9F, f10).endVertex();
        tessellator1.draw();
        ...
        f10 = this.sunSize;
        mc.textureManager.bindTexture(SkyProviderMars.sunTexture);
        worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
        worldRenderer1.pos(last2, -f10, 100.0F, -f10).tex(0.0F, 0.0F).endVertex();
        worldRenderer1.pos(last2, f10, 100.0F, -f10).tex(1.0F, 0.0F).endVertex();
        worldRenderer1.pos(last2, f10, 100.0F, f10).tex(1.0F, 1.0F).endVertex();
        worldRenderer1.pos(last2, -f10, 100.0F, f10).tex(0.0F, 1.0F).endVertex();
        tessellator1.draw();
        ...
        Minecraft.getInstance().textureManager.bindTexture(SkyProviderMars.overworldTexture);
        worldRenderer1.begin(GL11.GL_QUADS, DefaultVertexFormats.POSITION_TEX);
        worldRenderer1.pos(last2, -f10, -100.0F, f10).tex(0F, 1.0F).endVertex();
        worldRenderer1.pos(last2, f10, -100.0F, f10).tex(1.0F, 1.0F).endVertex();
        worldRenderer1.pos(last2, f10, -100.0F, -f10).tex(1.0F, 0F).endVertex();
        worldRenderer1.pos(last2, -f10, -100.0F, -f10).tex(0F, 0F).endVertex();
        tessellator1.draw();
        ...
        double d0 = mc.player.getPosition().getY() - world.getHorizonHeight();
        ...
        if (d0 < 0.0D)
        {
            ...
            DefaultVertexFormats.POSITION.setupBufferState(0L);
            this.sky2VBO.draw(matrixStack.getLast().getMatrix(), GL11.GL_QUADS);
            VertexBuffer.unbindBuffer();
            DefaultVertexFormats.POSITION.clearBufferState();
            matrixStack.pop();
            f8 = 1.0F;
            ...
            Matrix4f last3 = matrixStack.getLast().getMatrix();
            worldRenderer1.pos(last3, -f8, f9, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, f8, f9, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, f8, f10, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, -f8, f10, f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, -f8, f10, -f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, f8, f10, -f8).color(0, 0, 0, 1.0F).endVertex();
            worldRenderer1.pos(last3, f8, f9, -f8).color(0, 0, 0, 1.0F).endVertex();
        ...
        matrixStack.push();
        matrixStack.translate(0.0F, -((float) (d0 - 16.0D)), 0.0F);
        this.sky2VBO.bindBuffer();
        DefaultVertexFormats.POSITION.setupBufferState(0L);
        this.sky2VBO.draw(matrixStack.getLast().getMatrix(), GL11.GL_QUADS);
        VertexBuffer.unbindBuffer();
    ...
    private void renderStars(BufferBuilder worldRenderer)
    {
        ...
        for (int starIndex = 0; starIndex < (ConfigManagerCore.moreStars.get() ? 35000 : 6000); ++starIndex)
        {
            ...
            if (var12 < 1.0D && var12 > 0.01D)
            {
                ...
                var6 *= var12;
                var8 *= var12;
                final double var14 = var4 * (ConfigManagerCore.moreStars.get() ? rand.nextDouble() * 150D + 130D : 100.0D);
                final double var16 = var6 * (ConfigManagerCore.moreStars.get() ? rand.nextDouble() * 150D + 130D : 100.0D);
                final double var18 = var8 * (ConfigManagerCore.moreStars.get() ? rand.nextDouble() * 150D + 130D : 100.0D);
